...
from django.contrib.auth.models import UserManager, PermissionsMixin, Permission, Group
from django.core.validators import FileExtensionValidator
from django.db.models import BooleanField, CharField, UUIDField, DateTimeField, ImageField, TextChoices, Model, \
    ForeignKey, CASCADE, EmailField, FileField, DateField, TextField, OneToOneField, ManyToManyField
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    city = ForeignKey('basic.District', CASCADE, blank=True, null=True)
...
class CandidateProfile(Model):
    ...
    desired_city = ForeignKey('basic.District', CASCADE, verbose_name='Istalgan hudud')
...
class RecentlyViewedAds(Model):
    ...
    basic = ForeignKey('basic.Advert', CASCADE)
